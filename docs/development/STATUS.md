...
A2.78 in progress (Patch 3 complete)
...
Current focus:
- execute guardrail threshold recalibration and import-budget expansion (A2.78 patch 4)
- preserve no-growth guardrail discipline from updated baselines (`1896`/`283`)
