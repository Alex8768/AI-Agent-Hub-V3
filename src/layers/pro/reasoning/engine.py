...
from src.layers.pro.reasoning.evaluation.runtime_productization import (
    ...
    execute_fallback_planner_steps_with_full_runtime_dependencies as _execute_fallback_planner_steps_with_full_runtime_dependencies,
