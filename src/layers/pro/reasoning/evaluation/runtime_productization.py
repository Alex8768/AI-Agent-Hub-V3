...
async def synthesize_fallback_with_full_runtime_dependencies(
    *,
    request: object,
    retriever: object,
    error: str | None,
    ...
    async def _execute_planner_steps_mvp_fn(*, request: object) -> list[dict[str, object]]:
        return await execute_fallback_planner_steps_mvp(
            request=request,
            create_reasoning_plan_fn=create_reasoning_plan_fn,
            build_reasoning_execution_policy_fn=build_reasoning_execution_policy_fn,
    ...
    return await synthesize_fallback_with_runtime_and_text_adapter(
        request=request,
        retriever=retriever,
        error=error,
        get_settings_fn=get_settings_fn,
        ...
        build_prompt_fn=build_prompt_fn,
        dry_run_builder_fn=dry_run_builder_fn,
        execute_planner_steps_mvp_fn=_execute_planner_steps_mvp_fn,
        build_fallback_planner_observations_fn=build_fallback_planner_observations_fn,
        build_fallback_answer_response_fn=build_fallback_answer_response_fn,
        apply_fallback_response_diagnostics_fn=apply_fallback_response_diagnostics_fn,
        confidence_fn=confidence_fn,
