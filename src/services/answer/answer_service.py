...
def _response_runtime_parity_helpers():
    ...
    return importlib.import_module("src.services.answer.response.runtime_parity_helpers")


def _build_planner_runtime_parity_fallback_bundle(*, diagnostics: dict[str, object]) -> dict[str, object]:
    return _response_runtime_parity_helpers().build_planner_runtime_parity_fallback_bundle(
...
def _build_conversational_runtime_parity_bundle(
    *,
    ...
    return _response_runtime_parity_helpers().build_conversational_runtime_parity_bundle(
        diagnostics=diagnostics,
        query=query,
        answer=answer,
